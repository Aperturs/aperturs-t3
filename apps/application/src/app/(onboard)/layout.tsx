...
export default function RootLayout({
  ...
  return (
    <div className="relative h-[100dvh] w-full dark:bg-black">
      ...
      <div className="absolute  left-0 right-0 top-[-10%] hidden h-[1000px] w-[1000px] rounded-full bg-[radial-gradient(circle_400px_at_50%_300px,#fbfbfb36,#000)] dark:block"></div>
    </div>
  );
}
