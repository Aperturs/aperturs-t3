export default function Privacy() {
  return (
    <section>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Aperturs, Telangana, India.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Aperturs, accessible from{" "}
            <a
              href="https://aperturs.com"
      ...
      <ul>
        <li>By email: aperturs.cs@gmail.com</li>
      </ul>
    </section>
  );
}
