...
export default function page() {
  return (
    <section className="flex w-full flex-col items-center justify-center py-24 md:py-48">
      ...
      <div className="relative md:m-0 m-[-100px]">
        ...
        <FadeIn duration={4} initialY={0}>
          <div className="gradient absolute left-[50%] top-[-200px] h-[400px] md:h-[700px] w-[90vw] " />
        </FadeIn>
        1
      </div>
    </section>
