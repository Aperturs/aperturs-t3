...
interface MultiSelectProps
  ...
  /**
   * The maximum number of options that can be selected. If the number of selected
   * options exceeds this limit, the extra options will be summarized.
   * Optional, defaults to no limit.
   */
  maximumAllowed?: number;

  /**
   * If true, the select all option will be displayed at the top of the list.
   * Optional, defaults
   */
  ...
  (
    ...
    const toggleOption = (value: string) => {
      ...
      if (
        maximumAllowed &&
        !isAlreadySelected &&
        selectedValues.length >= maximumAllowed
      ) {
        return;
      }
